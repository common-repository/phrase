...
/**
 * Whether the current post is of type supported by Phrase.
 *
 * @param {Object} state Global application state.
 * @return {boolean} True if currently edited post is of supported type.
 */
export const isSupportedPostType = createRegistrySelector( ( select ) => () => {
